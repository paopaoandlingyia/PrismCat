...
- 保持配置兼容：原有单目标 `upstreams.<name>.target` 配置无需迁移，也可以继续使用。
...
完整变更记录：[v1.13.0...v1.14.0](https://github.com/paopaoandlingyia/PrismCat/compare/v1.13.0...v1.14.0)
...
- Preserved configuration compatibility: the existing single-target `upstreams.<name>.target` format still works without migration.
...
Full changelog: [v1.13.0...v1.14.0](https://github.com/paopaoandlingyia/PrismCat/compare/v1.13.0...v1.14.0)
